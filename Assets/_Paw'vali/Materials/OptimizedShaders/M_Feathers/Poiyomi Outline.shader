Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/6ec94ba96c717b646a8b647df8a9c9a7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.025 /*_DissolveDetailStrength*/);
				...
				switch((4.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.045 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						dds *= smoothstep(1, 0.99, da) * lerp(1, smoothstep(0, lerp(0.01, 0.1, dds), da), (0.094 /*_DissolveDetailEdgeSmoothing*/));
						...
						edgeAlpha = remapClamped(da + (0.045 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.045 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.045 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						dds *= smoothstep(0, 0.2*dds + 0.01, dissolveAlpha) * lerp(1, smoothstep(1, 1 - 0.2*dds - 0.01, dissolveAlpha), (0.094 /*_DissolveDetailEdgeSmoothing*/));
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.045 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.045 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.045 /*_DissolveEdgeWidth*/) || ((4.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(1,0.2652483,0.961996,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(1,0.2652483,0.961996,1).a);
					#ifndef POI_SHADOW
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (0.163 /*_BaseColor_Step*/) - (0.342 /*_BaseShade_Feather*/);
				...
				firstShadeMap.rgb *= float4(0.06511068,0.06511068,0.06511068,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.163 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
				...
				mainShadowMask *= poiLight.shadowMask * (0.693 /*_ShadowStrength*/);
				firstSecondShadowMask *= poiLight.shadowMask * (0.693 /*_ShadowStrength*/);
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.693 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.6 /*_EmissionStrength*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.08393915,0.08393915,0.08393915,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.08393915,0.08393915,0.08393915,1).a);
