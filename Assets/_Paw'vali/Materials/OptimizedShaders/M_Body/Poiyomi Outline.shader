Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/5e58c058b99314540979059135dc1e78"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				#endif
				float MainColorFeatherStep = (0.158 /*_BaseColor_Step*/) - (0.281 /*_BaseShade_Feather*/);
				...
				firstShadeMap.rgb *= float4(0.0651107,0.0651107,0.0651107,1).rgb; //* lighColor
				...
				float mainShadowMask = saturate(1 - ((poiLight.lightMap) - MainColorFeatherStep) / ((0.158 /*_BaseColor_Step*/) - MainColorFeatherStep) * (shadowMask));
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.08393916,0.08393916,0.08393916,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.08393916,0.08393916,0.08393916,1).a);
